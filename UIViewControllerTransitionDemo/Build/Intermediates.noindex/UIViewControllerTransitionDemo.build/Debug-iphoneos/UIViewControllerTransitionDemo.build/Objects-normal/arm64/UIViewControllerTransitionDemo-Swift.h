...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UIViewControllerTransitionDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo11AppDelegate")
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo23FadeInFadeOutTransition")
@interface FadeInFadeOutTransition : NSObject <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo21HomeAddViewController")
@interface HomeAddViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo22HomeItemViewController")
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo24HomeNavigationController")
...
@interface HomeNavigationController (SWIFT_EXTENSION(UIViewControllerTransitionDemo)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo18HomeViewController")
@interface HomeViewController : UIViewController
- (IBAction)itemButtonTapped:(id _Nonnull)sender;
- (IBAction)addButtonTapped:(id _Nonnull)sender;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo24MainTabBarViewController")
...
@interface MainTabBarViewController (SWIFT_EXTENSION(UIViewControllerTransitionDemo)) <UITabBarControllerDelegate>
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo13SceneDelegate")
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo30SlideFromLeftToRightTransition")
@interface SlideFromLeftToRightTransition : NSObject <UIViewControllerAnimatedTransitioning>
- (id <UIViewImplicitlyAnimating> _Nonnull)interruptibleAnimatorForTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext SWIFT_WARN_UNUSED_RESULT;
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning> _Nullable)transitionContext SWIFT_WARN_UNUSED_RESULT;
- (void)animateTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext;
- (void)animationEnded:(BOOL)transitionCompleted;
...
SWIFT_CLASS("_TtC30UIViewControllerTransitionDemo20SwipeBackInteractive")
@interface SwipeBackInteractive : UIPercentDrivenInteractiveTransition
